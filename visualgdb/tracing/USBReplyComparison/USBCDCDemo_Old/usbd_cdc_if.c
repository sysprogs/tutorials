...
static int8_t USBCDCDemo_Old_Init     (void);
static int8_t USBCDCDemo_Old_DeInit   (void);
static int8_t USBCDCDemo_Old_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t USBCDCDemo_Old_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_USBCDCDemo_Old_fops = 
{
  USBCDCDemo_Old_Init,
  USBCDCDemo_Old_DeInit,
  USBCDCDemo_Old_Control,
  USBCDCDemo_Old_Receive
};
...
/**
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t USBCDCDemo_Old_Receive(uint8_t* Buf, uint32_t *Len)
{
