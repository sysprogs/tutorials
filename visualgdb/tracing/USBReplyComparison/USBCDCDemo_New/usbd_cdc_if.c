...
static int8_t USBCDCDemo_New_Init     (void);
static int8_t USBCDCDemo_New_DeInit   (void);
static int8_t USBCDCDemo_New_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t USBCDCDemo_New_Receive  (uint8_t* pbuf, uint32_t *Len);
static int8_t USBCDCDemo_New_TransmitCompleted(uint8_t *Buf, uint32_t *Len, uint8_t epnum);

USBD_CDC_ItfTypeDef USBD_CDC_USBCDCDemo_New_fops = 
{
  USBCDCDemo_New_Init,
  USBCDCDemo_New_DeInit,
  USBCDCDemo_New_Control,
  USBCDCDemo_New_Receive,
  USBCDCDemo_New_TransmitCompleted
};
...
/**
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t USBCDCDemo_New_Receive(uint8_t* Buf, uint32_t *Len)
{
