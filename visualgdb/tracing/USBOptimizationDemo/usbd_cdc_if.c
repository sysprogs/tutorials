...
static int8_t USBOptimizationDemo_Init     (void);
static int8_t USBOptimizationDemo_DeInit   (void);
static int8_t USBOptimizationDemo_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t USBOptimizationDemo_Receive  (uint8_t* pbuf, uint32_t *Len);

USBD_CDC_ItfTypeDef USBD_CDC_USBOptimizationDemo_fops = 
{
  USBOptimizationDemo_Init,
  USBOptimizationDemo_DeInit,
  USBOptimizationDemo_Control,
  USBOptimizationDemo_Receive
};
...
/**
  * @brief  USBOptimizationDemo_Init
...
/**
  * @brief  USBOptimizationDemo_DeInit
...
/**
  * @brief  USBOptimizationDemo_Control
...
/**
  * @brief  USBOptimizationDemo_Receive
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t USBOptimizationDemo_Receive(uint8_t* Buf, uint32_t *Len)
{
