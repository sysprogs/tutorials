...
static int8_t StandaloneFrameworkDemo_Init     (void);
static int8_t StandaloneFrameworkDemo_DeInit   (void);
static int8_t StandaloneFrameworkDemo_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t StandaloneFrameworkDemo_Receive  (uint8_t* pbuf, uint32_t *Len);
static int8_t StandaloneFrameworkDemo_TransmitCompleted(uint8_t *Buf, uint32_t *Len, uint8_t epnum);

USBD_CDC_ItfTypeDef USBD_CDC_StandaloneFrameworkDemo_fops = 
{
  StandaloneFrameworkDemo_Init,
  StandaloneFrameworkDemo_DeInit,
  StandaloneFrameworkDemo_Control,
  StandaloneFrameworkDemo_Receive,
  StandaloneFrameworkDemo_TransmitCompleted
};
...
/**
  * @brief  StandaloneFrameworkDemo_Init
...
/**
  * @brief  StandaloneFrameworkDemo_DeInit
...
/**
  * @brief  StandaloneFrameworkDemo_Control
...
/**
  * @brief  StandaloneFrameworkDemo_Receive
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t StandaloneFrameworkDemo_Receive(uint8_t* Buf, uint32_t *Len)
{
