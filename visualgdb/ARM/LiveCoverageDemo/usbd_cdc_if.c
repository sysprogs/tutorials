...
static int8_t LiveCoverageDemo_Init     (void);
static int8_t LiveCoverageDemo_DeInit   (void);
static int8_t LiveCoverageDemo_Control  (uint8_t cmd, uint8_t* pbuf, uint16_t length);
static int8_t LiveCoverageDemo_Receive  (uint8_t* pbuf, uint32_t *Len);
static int8_t LiveCoverageDemo_TransmitCompleted(uint8_t *Buf, uint32_t *Len, uint8_t epnum);

USBD_CDC_ItfTypeDef USBD_CDC_LiveCoverageDemo_fops = 
{
  LiveCoverageDemo_Init,
  LiveCoverageDemo_DeInit,
  LiveCoverageDemo_Control,
  LiveCoverageDemo_Receive,
  LiveCoverageDemo_TransmitCompleted
};
...
/**
  * @brief  LiveCoverageDemo_Control
...
/**
  * @brief  LiveCoverageDemo_Receive
  ...
  * @retval Result of the operation: USBD_OK if all operations are OK else USBD_FAIL
  */
static int8_t LiveCoverageDemo_Receive(uint8_t* Buf, uint32_t *Len)
{
